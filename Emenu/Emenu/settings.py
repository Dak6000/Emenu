...
SECRET_KEY = 'django-insecure-*1=r1#=rlxa=-%3#f)p70*3$knob*!g-&6_x-o7$zm&aal#yyo'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'accounts.context_processors.structure_context',
            ],
        },
    },
]
...
DATABASES = {
    'default': {
        ...
        'OPTIONS': {
            ...
            'charset': 'utf8mb4',  # Utilise utf8mb4 pour supporter les emojis/4 octets
        },
    }
}
